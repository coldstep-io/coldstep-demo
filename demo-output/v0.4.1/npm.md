...
**Run:** [27513828839](https://github.com/coldstep-io/coldstep-demo/actions/runs/27513828839) · job `npm-demo` · sha `58dcafb`
...
59 fork events; 8 `exec()` calls captured. Binaries executed:
...
| :---------- | :------ | :- | :----- | -----: |
| `104.16.4.34` | 0,443 | libuv-worker, npm install exp | monitor | 17 |
| `104.16.11.34` | 0,443 | libuv-worker, npm install @aw | monitor | 17 |
| `168.63.129.16` | 53,80,32526 | python3, systemd-resolve | monitor | 14 |
| `127.0.0.53` | 53 | hosted-compute-, libuv-worker, node | monitor | 11 |
| `127.0.0.1` | 44311,49144,50198,52962,53237 | systemd-resolve | monitor | 8 |
...
| `104.16.2.34` | 0 | libuv-worker | monitor | 2 |
| `104.16.1.34` | 0 | libuv-worker | monitor | 2 |
...
| :------- | :----------------- | :- | -----: |
| `registry.npmjs.org` | `104.16.11.34`, `104.16.4.34` | npm install @aw, npm install exp | 30 |
...
---
_Raw telemetry: `.coldstep-events.jsonl` (5,324 events) is attached to the [run artifacts](https://github.com/coldstep-io/coldstep-demo/actions/runs/27513828839)._
